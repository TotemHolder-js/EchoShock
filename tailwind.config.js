...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      typography: (theme) => ({
        DEFAULT: {
          css: {
            ...
            code: { color: theme('colors.ember.DEFAULT'), backgroundColor: theme('colors.steel.medium'), padding: '0.2em 0.4em', borderRadius: '0.25em' },
            blockquote: {
      ...
      backgroundImage: {
        'accent-gradient': 'linear-gradient(90deg, var(--flame-start), var(--flame-end))',
        'surface-bevel': 'linear-gradient(145deg, var(--steel-light), var(--steel-medium))',
      },
      boxShadow: {
        'accent-glow': '0 0 8px 0px hsl(var(--primary) / 0.7), 0 0 12px 0px hsl(var(--secondary) / 0.6)',
        'inner-bevel': 'inset 0 1px 2px rgba(0,0,0,0.5), inset 0 -1px 1px hsl(var(--steel-light) / 0.5)',
